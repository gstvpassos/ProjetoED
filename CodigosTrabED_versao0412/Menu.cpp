    ...
    do{
        ...
        switch (opcao){
            ...
            case 4:
                ...
                opcaoComando = opcaoImprime();
                impressaoArquivo(opcaoComando);
                break;
            case 5:
                //int opcaoExport = opcaoExporta();
                opcaoComando = opcaoExporta();
                (opcaoComando == 2) ? binario.exportarBin() : binario.exportarCSV();
                break;
            case 6:
                //int opcaoSaida = confirmaSaida();
                opcaoComando = confirmaSaida();
                (opcaoComando == 1) ? exit(1) : executaMenu();
            default:
